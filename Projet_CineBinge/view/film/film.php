<?php
    ...
    $unFilm = FilmDAO::getOneById(2);
        $titre = $unFilm->getTitre();
        $affiche = $unFilm->getAffiche();
        $bandeAnnonce = $unFilm->getBandeAnnonce();
?>
<div class="cbp-l-project-title">Dashboard 123</div>
<div class="cbp-l-project-subtitle">by Paul Flavius Nechita</div>

<div class="cbp-slider">
    <ul class="cbp-slider-wrap">
        <li class="cbp-slider-item">
            <img src="theme/assets/base/img/content/stock3/1.jpg" alt="">
        </li>
        <li class="cbp-slider-item">
            <img src="theme/assets/base/img/content/stock3/2.jpg" alt="">
        </li>
        <li class="cbp-slider-item">
            <img src="theme/assets/base/img/content/stock3/3.jpg" alt="">
        </li>
    </ul>
</div>
        ...
        <ul class="cbp-l-project-related-wrap">
            <li class="cbp-l-project-related-item">
                <a href="ajax/project12.html" class="cbp-singlePage cbp-l-project-related-link">
                    <img src="theme/assets/base/img/content/stock/03.jpg" alt="">
            ...
            <li class="cbp-l-project-related-item">
                <a href="ajax/project2.html" class="cbp-singlePage cbp-l-project-related-link">
                    <img src="theme/assets/base/img/content/stock/07.jpg" alt="">
            ...
            <li class="cbp-l-project-related-item">
                <a href="ajax/project3.html" class="cbp-singlePage cbp-l-project-related-link">
                    <img src="theme/assets/base/img/content/stock/66.jpg" alt="">
